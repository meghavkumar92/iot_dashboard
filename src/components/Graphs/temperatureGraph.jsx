      ...
      render() { 
          ...
          return ( 
            <div /* style={styles} */>
              ...
              <div> <Button  onClick={this.getTemperature.bind(this, "Week")}>Last Week Graph</Button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <Button  onClick={this.getTemperature.bind(this, "Last")}>Last 24hrs Graph</Button></div>
